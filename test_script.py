...
data = WavenetDataset(dataset_file='_train_samples/saber/dataset.npz',
                      item_length=context_model.receptive_field + context_model.output_length - 1,
...
print('model: ', model)
print('receptive field: ', context_model.receptive_field)
print('parameter count: ', model.parameter_count() + context_model.parameter_count())
